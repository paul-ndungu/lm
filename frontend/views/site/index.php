        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div style="padding-top: 20px;">
               <?=Html::a(Yii::t('app', '<i class="fa fa-plus" aria-hidden="true"></i> Assign Book'), ['assign-book/index'], ['class'=> 'btn btn-block btn-success btn-lg assighnbook','style'=>'width: 300px;' ])?>
